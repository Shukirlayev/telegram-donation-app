                    ...
                    <div className="relative z-10 w-full">
                      <div className="flex justify-between items-start mb-3">
                         ...
                         <div className="flex items-center gap-1">
                           <button onClick={(e) => { e.stopPropagation(); triggerHaptic('heavy'); handleCompleteGoal(goal.id); }} className="p-2 text-slate-400 hover:text-emerald-500 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full transition-all active:scale-90" title="Tugatish"><CheckCircle2 className="w-[18px] h-[18px]" /></button>
                           <button onClick={() => { 
                               triggerHaptic('light');
                           ...
                           <button onClick={() => { triggerHaptic('heavy'); handleDeleteGoal(goal.id); }} className="p-2 text-slate-400 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full transition-all active:scale-90" title="O'chirish"><Trash2 className="w-[18px] h-[18px]" /></button>
                         </div>
                      </div>
