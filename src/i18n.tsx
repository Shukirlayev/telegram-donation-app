...
export const translations = {
  uz: {
    ...
    home: {
       ...
       millionSaved: "1M+ {currency} yig'ildi",
       streak: "Kun",
       ...
       aiMillion: "Siz 1 Million {currency} dan ortiq mablag' yig'ishga muvaffaq bo'ldingiz! Ajoyib natija! 🔥",
       aiProgress: "Siz umumiy hisobda {amount} {currency} yig'dingiz. Rejali tejashni davom ettirsangiz, barchasiga tezda erishasiz.",
       goals: "Maqsadlar",
       add: "Qo'shish",
  ...
  ru: {
    ...
    home: {
       ...
       millionSaved: "Накоплено 1M+ {currency}",
       streak: "Дней",
       ...
       aiMillion: "Вы смогли накопить более 1 миллиона {currency}! Отличный результат! 🔥",
       aiProgress: "Вы накопили в общей сложности {amount} {currency}. Продолжайте планировать сбережения, и вы быстро достигнете всего.",
       goals: "Цели",
       add: "Добавить",
  ...
  en: {
    ...
    home: {
       ...
       millionSaved: "Saved 1M+ {currency}",
       streak: "Days",
       ...
       aiMillion: "You have successfully saved more than 1 Million {currency}! Great result! 🔥",
       aiProgress: "You have saved a total of {amount} {currency}. Keep saving systematically and you will reach your goals quickly.",
       goals: "Goals",
       add: "Add",
